 ...
 */
========================================================================
		ActiveX Control DLL : SCEMFAX
========================================================================

ControlWizard has created this project for your SCEMFAX ActiveX Control
...
that make up your SCEMFAX ActiveX Control DLL.
...
SCEMFAxCtl.h
	This file contains the declaration of the CSCEMFAxCtrl C++ class.

SCEMFAxCtl.cpp
	This file contains the implementation of the CSCEMFAxCtrl C++ class.

SCEMFAxPpg.h
	This file contains the declaration of the CSCEMFAxPropPage C++ class.

SCEMFAxPpg.cpp
	This file contains the implementation of the CSCEMFAxPropPage C++ class.

SCEMFAxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSCEMFAxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file SCEMFAx.rc.
